...
#SBATCH --output=1d_iter_input_8.out
...
python 1D_iter_fit_full_script_with_dir.py --alpha_cc 0.20 --alpha_Ia 0.80 --g_cc 0.20 --g_ratio 1.60 --save_dir "unity_models_8"