...
#SBATCH --output=1d_iter_input_1_%j.out
...
python 1D_iter_fit_full_script_with_dir.py --alpha_cc 0.50 --alpha_Ia 0.40 --g_cc 0.80 --g_ratio 1.90 --save_dir "unity_models_5"