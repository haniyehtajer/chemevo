...
met_dep_param_to_fit_name = "alpha_cc"

for param_count in range(len(met_dep_param_to_fit)):
    alpha_cc_this_model = met_dep_param_to_fit[param_count]
    gals_list = []
    ...
    df_endpoints.to_csv(f"models/{met_dep_param_to_fit_name}_iter2_{param_count}.csv", index=False)
